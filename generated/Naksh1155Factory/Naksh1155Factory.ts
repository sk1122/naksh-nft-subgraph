...
export class Naksh1155Factory__deployNftCollectionInputArtistStruct extends ethereum.Tuple {
  get name(): string {
...
export class Naksh1155Factory__deployNftCollectionInputCollectionStruct extends ethereum.Tuple {
  get name(): string {
    return this[0].toString();
  }
  ...
  get cover(): Naksh1155Factory__deployNftCollectionInputCollectionCoverStruct {
    return changetype<
      Naksh1155Factory__deployNftCollectionInputCollectionCoverStruct
    >(this[4].toTuple());
  }

  get social(): Naksh1155Factory__deployNftCollectionInputCollectionSocialStruct {
    return changetype<
      Naksh1155Factory__deployNftCollectionInputCollectionSocialStruct
    >(this[5].toTuple());
  }
}

export class Naksh1155Factory__deployNftCollectionInputCollectionCoverStruct extends ethereum.Tuple {
  get uri(): string {
    return this[0].toString();
  }
...
export class Naksh1155Factory__deployNftCollectionInputCollectionSocialStruct extends ethereum.Tuple {
...
export class Naksh1155Factory extends ethereum.SmartContract {
  static bind(address: Address): Naksh1155Factory {
    return new Naksh1155Factory("Naksh1155Factory", address);
  }

  deployNftCollection(
    artist: Naksh1155Factory__deployNftCollectionInputArtistStruct,
    collection: Naksh1155Factory__deployNftCollectionInputCollectionStruct,
    _admin: Address,
